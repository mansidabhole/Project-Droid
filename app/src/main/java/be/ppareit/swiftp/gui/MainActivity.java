...
public class MainActivity extends PreferenceActivity implements OnSharedPreferenceChangeListener {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        Preference proj_folder = findPref("Project Folder");
        proj_folder.setSummary(FsSettings.getChrootDirAsString());
        proj_folder.setOnPreferenceClickListener(preference -> {
            File folder = new File(Environment.getExternalStorageDirectory() +
                    File.separator + "Project Folder");
           ...
           /* File reportdirectory = new File("/sdcard/Project Folder/Rohit");
            reportdirectory.mkdirs();
            File output = new File(reportdirectory,"Report1");
            FileOutputStream fos = new FileOutputStream(output);*/

            File main1 = new File(Environment.getExternalStorageDirectory()+File.separator+"/Project Folder/Rohit");
            if (!main1.exists()){
                main1.mkdirs();
            }
            File main2 = new File(Environment.getExternalStorageDirectory()+File.separator+"/Project Folder/Mansi");
            if (!main2.exists()){
                main2.mkdirs();
            }
            File main3 = new File(Environment.getExternalStorageDirectory()+File.separator+"/Project Folder/Gaurav");
            if (!main3.exists()){
                main3.mkdirs();
            }
            ...
            File out1 = new File(main1, "Report.xls");
            try {
                FileOutputStream outputStream = new FileOutputStream(out1);
            } catch (FileNotFoundException e) {
                e.printStackTrace();
            }

            File out2 = new File(main2, "Report.xls");
            try {
                FileOutputStream outputStream = new FileOutputStream(out2);
            } catch (FileNotFoundException e) {
                e.printStackTrace();
            }

            File out3 = new File(main3, "Report.xls");
            try {
                FileOutputStream outputStream = new FileOutputStream(out3);
            } catch (FileNotFoundException e) {
                e.printStackTrace();
            }
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (item.getItemId() == R.id.action_feedback) {
            String to = "rohit.kothavade96@gmail.com";
